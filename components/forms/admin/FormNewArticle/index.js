      ...
      {({ errors }) => (
        <Form className={styles.form_article} encType="multipart/form-data">
          <div className={`${styles.form_inputs} `}>
            <InputTextFormik name="title" label="Título" error={errors.title} />
            {/* <InputTextFormik name="subtitle" label="Subtítulo" /> */}
          </div>
          <div className={styles.form_inputs}>
          ...
          <InputTextFormik name="meta_description" label="Meta Description" />
